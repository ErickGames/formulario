...
<body>
    ...
    <div class="row m-0">
        ...
        <div class="col-11">
            <div id="myProgress" class="w3-light-grey m-4" style="border-radius:20px">
                <div id="myBar" class="w3-container w3-green w3-center" style="width:0%; border-radius:20px">0%
                </div>
            </div>
        </div>
    </div>

    <form action="10m_proyecto_personal.php" method="POST" class="m-4 bordesito" id="form1">
    ...
    <script>
        ...
        function move() {
            ...
            var width = 0; // Obtener el valor actual 
