...
<body>
    ...
    <form action="Finalizar.php" method="POST" class="m-4 bordesito">

        <!-- PREGUNTA 1 -->
        <div class="p-4" style="background-color:rgba(39, 52, 128)">

            <h4 class="mb-3 " style="color: white">Tiempo dedicado a la clínica / consultorio propio</h4>
        ...
        <div class="p-4" style="background-color:rgba(39, 52, 128)">
            ...
            <h4 class="mb-3 " style="color: white">Madurez del negocio</h4>
        ...
        <div class="p-4" style="background-color:rgba(39, 52, 128)">
            ...
            <h4 Class="mb-3 " style="color: white">Conformidad personal</h4>
        ...
        <div class="p-4" style="background-color:rgba(39, 52, 128)">
            ...
            <h4 Class="mb-3 " style="color: white">Pasión</h4>
        ...
        <div class="p-4" style="background-color:rgba(39, 52, 128)">
            ...
            <h4 Class="mb-3 " style="color: white">Persistencia</h4>
        ...
        <div class="p-4" style="background-color:rgba(39, 52, 128)">
            ...
            <h4 Class="mb-3 " style="color: white">Autoestima</h4>
