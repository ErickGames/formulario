    ...
    <form action="" class="m-5">
        ...
        <div class="p-5" style="background-color:rgba(61, 177, 102, 0.1)">
            ...
            <div class="form-check mx-4">
                <input class="form-check-input" type="radio" name="" id="">
                <label class="form-check-label" for="">
                Se cuenta con una planeación integral con apoyo externo, se ejecutar y monitorea con recursos internos.
                </label>
            </div>
            <div class="form-check mx-4">
                <input class="form-check-input" type="radio" name="" id="">
                <label class="form-check-label" for="">
                Se cuenta con una planeación fiscal anual, seguimiento y ejecución al mayor nivel asegurando eficiencias contables.
                </label>
            </div>
        </div>
