...
<body>
    ...
    <div class=" row mx-5 mt-5">
        <div class="col-md-1">
            <img src="img/secciones/fiscal.jpg" alt="" style="display:block; margin:auto; width:100%">
        </div>
        <div class="col-md-7">
            <h2 class="section-title">FISCAL Y LEGAL</h2>
        </div>
    ...
    <div class="row m-0">
        ...
        <div class="col-11">
            <div id="myProgress" class="w3-light-grey m-4" style="border-radius:20px">
                <div id="myBar" class="w3-container w3-green w3-center" style="width:41.6%; border-radius:20px">43%
                </div>
            </div>
        </div>
    </div>
...
<div id="popup" style="display: none; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 65%; z-index: 9999; background-color: white; padding: 20px; border: 1px solid black; text-align: center;">
    ...
    <img src="img/separador/separador_2.jpg" alt="Imagen Emergente" style="max-width: 100%; max-height: 100%;">
</div>
