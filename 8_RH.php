    ...
    <form action="" class="m-5">
        ...
        <div class="p-5" style="background-color:rgba(61, 177, 102, 0.1)">
            ...
            <div class="form-check mx-4">
                <input class="form-check-input" type="radio" name="" id="">
                <label class="form-check-label" for="">
                Se tiene para todas las posiciones y se les da seguimiento aunque no se actualizan cada periodo definido.
                </label>
            </div>
            <div class="form-check mx-4">
                <input class="form-check-input" type="radio" name="" id="">
        ...
        <div class="p-5" style="background-color:rgba(25, 47, 89, 0.1)">
            ...
            <div class="form-check mx-4">
                <input class="form-check-input" type="radio" name="" id="">
                <label class="form-check-label" for="">
                Se tiene para todas les posiciones y se les da seguimiento aunque no se actualizan cada periodo definido.
                </label>
            </div>
            <div class="form-check mx-4">
                <input class="form-check-input" type="radio" name="" id="">
        ...
        <div class="p-5" style="background-color:rgba(61, 177, 102, 0.1)">
            ...
            <div class="form-check mx-4">
                <input class="form-check-input" type="radio" name="" id="">
                <label class="form-check-label" for="">
                Se contrata y mantiene un equipo estable, motivado y proactivo con una mezcla entre percepciones fijas y otra por comisiones.
                </label>
            </div>
            <div class="form-check mx-4">
                <input class="form-check-input" type="radio" name="" id="">
                <label class="form-check-label" for="">
                Se contrata y mantiene un equipo estable, motivado y proactivo con una mezcla entre percepciones fijas y otra por comisiones , además de tener planes de desarrollo en el para el corto, mediano  y largo plazo.
                </label>
            </div>
        </div>
        ...
        <div class="p-5" style="background-color:rgba(61, 177, 102, 0.1)">
            ...
            <div class="form-check mx-4">
                <input class="form-check-input" type="radio" name="" id="">
                <label class="form-check-label" for="">
                Cuento con un equipo de Rh interno que me hace la búsqueda y para ciertas posiciones contrato también a un agente de apoyo.
                </label>
            </div>
        </div>
        ...
        <div class="p-5" style="background-color:rgba(61, 177, 102, 0.1)">
            ...
            <div class="form-check mx-4">
                <input class="form-check-input" type="radio" name="" id="">
                <label class="form-check-label" for="">
                Se tiene un sistema de asignación de responsabilidades y prioridades de corto plazo y se va ajustando diariamente realizando.
                </label>
            </div>
            <div class="form-check mx-4">
                <input class="form-check-input" type="radio" name="" id="">
                <label class="form-check-label" for="">
                Hay una persona encargada de esto y siguiendo los procesos optimizando el tiempo de las personas y evitando incluir en servicios por au.
                </label>
            </div>
        </div>
