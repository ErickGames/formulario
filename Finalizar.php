...
<body>
    ...
    <div class="mx-5 mt-5">
        <h2>PENDIENTES</h2>
        <h4>--INGRESO DE DATOS (NOMBRE, CORREO, ETC) -> puede ser una panmtalla anterior a esta que solo sea el ingreso de datos, y despues redirija a esta. (cambiar action del form en pag 10 y cambiar codigo php que valida el POST)</h4>
